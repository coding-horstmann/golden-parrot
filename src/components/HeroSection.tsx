...
const HeroSection = () => {
  ...
  return (
    <section id="hero" className="min-h-screen flex items-center relative overflow-hidden pt-28">
      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <h1 className="text-3xl md:text-5xl font-bold font-inter mb-6 leading-tight">
            <span className="text-white">Agentur für innovative KI-Videoproduktion:</span>{' '}
          ...
          <p className="text-xl md:text-2xl text-white/90 mb-8 max-w-3xl mx-auto leading-relaxed">
            Mit modernster Künstlicher Intelligenz erstellen wir in nur wenigen Tagen maßgeschneiderte Social‑Media‑und Unternehmensvideos
          </p>
          ...
          >
            <span>Video erstellen lassen</span>
            <ArrowRight size={20} />
          </button>
